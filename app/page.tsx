...
export default function Home() {
  ...
  const handleOpenReview = (value: boolean) => {
    setReview(value);
  };
  ...
  return (
    <main className="min-h-screen bg-gray-50">
      <div className="w-full ">
        {!isRegistered ? (
          ...
          <div className="mx-auto mb-12 max-w-lg text-center p-6 bg-white rounded-lg shadow-lg">
            {review && <Feedback handleOpenReview={handleOpenReview} />}
            ...
            <p className="mb-6 text-lg font-normal text-gray-600">
              Your trusted AI assistant for legal insights on Cameroon laws and
              the penal code.
            </p>
            <i className="mb-6 text-sm font-light text-gray-400">
              Business, Succession, Penal, Land, and Labour Laws{" "}
            </i>
            <OpenAIAssistant
      ...
      <footer className="mt-auto mb-4 text-sm text-gray-500 text-center">
        &copy; {new Date().getFullYear()} Cameroon Lawyer. All rights reserved.
        <br></br>
        by{" "}
        <a href="https://nocodesolutions.tech/">
          <b className="ml-2 text-blue-500 hover:bg-blue-700">
            Nocode Solutions
          </b>
        </a>
      </footer>
